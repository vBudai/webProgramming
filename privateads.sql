...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 12 2022 г., 19:46
...
CREATE TABLE `category` (
  ...
  `mainCategory` set('Продажа','Работа','Услуги') NOT NULL COMMENT 'Главная категория',
  `sale` set('Транспорт','Недвижимость','Личные вещи','Электроника','Животные','Хобби и отдых') DEFAULT NULL COMMENT 'Подкатегория "Продажа"',
  `services` set('Транспорт/Перевозки','Праздники/Мероприятия','Ремонт/Строительство','Красота/Здоровье','Бытовые услуги','IT','Обучение','Установка техники','Ремонт техники') DEFAULT NULL COMMENT 'Подкатегория "Услуги"',
  `job` set('Вакансии','Резюме') DEFAULT NULL COMMENT 'Подкатегория "Работа"'
